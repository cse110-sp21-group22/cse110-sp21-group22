describe('Basic user flow for BuJo App', () => {
  ...
  // test 1
  it('Test1: Verify the url is correct when clicking on the calendar link',
     async () => {
  ...
  // test 2
  it('Test2: Verify the url is correct when clicking on the mood tracker link',
     async () => {
  ...
  // test 3
  it('Test3: Verify the url is correct when clicking on the settings link',
     async () => {
       await page.waitForTimeout(1000);
  ...
  // test 4
  it('Test4: Verify the url is correct when clicking on the home link',
     async () => {
       await page.waitForTimeout(1000);
