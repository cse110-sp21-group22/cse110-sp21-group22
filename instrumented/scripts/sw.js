function cov_2nda24wdjk() {
  ...
  var coverageData = {
    ...
    statementMap : {
      ...
      "1" : {start : {line : 2, column : 21}, end : {line : 29, column : 1}},
      "2" : {start : {line : 32, column : 0}, end : {line : 38, column : 3}},
      "3" : {start : {line : 33, column : 2}, end : {line : 37, column : 4}},
      "4" : {start : {line : 35, column : 6}, end : {line : 35, column : 42}},
      "5" : {start : {line : 41, column : 0}, end : {line : 47, column : 3}},
      "6" : {start : {line : 42, column : 2}, end : {line : 46, column : 4}},
      "7" : {start : {line : 44, column : 6}, end : {line : 44, column : 46}}
    },
    fnMap : {
      "0" : {
        name : "(anonymous_0)",
        decl :
            {start : {line : 32, column : 33}, end : {line : 32, column : 34}},
        loc : {start : {line : 32, column : 50}, end : {line : 38, column : 1}},
        line : 32
      },
      "1" : {
        name : "(anonymous_1)",
        decl :
            {start : {line : 34, column : 33}, end : {line : 34, column : 34}},
        loc : {start : {line : 34, column : 50}, end : {line : 36, column : 5}},
        line : 34
      },
      "2" : {
        name : "(anonymous_2)",
        decl :
            {start : {line : 41, column : 31}, end : {line : 41, column : 32}},
        loc : {start : {line : 41, column : 48}, end : {line : 47, column : 1}},
        line : 41
      },
      "3" : {
        name : "(anonymous_3)",
        decl :
            {start : {line : 43, column : 37}, end : {line : 43, column : 38}},
        loc : {start : {line : 43, column : 57}, end : {line : 45, column : 5}},
        line : 43
      }
    },
    branchMap : {
      "0" : {
        loc :
            {start : {line : 44, column : 13}, end : {line : 44, column : 45}},
        type : "binary-expr",
        locations : [
          {start : {line : 44, column : 13}, end : {line : 44, column : 21}},
          {start : {line : 44, column : 25}, end : {line : 44, column : 45}}
        ],
        line : 44
      }
    },
