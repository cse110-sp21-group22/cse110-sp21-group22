...
$("#datepicker1").bind('change', function(){
  ...
  if(semester_end != undefined && semester_start != undefined){
    ...
    else if(progress <= 25 && progress > 5) PROGRESS_BAR.style.backgroundColor = "organge";
    else if(progress <= 50 && progress > 25) PROGRESS_BAR.style.backgroundColor = "gold";
    else if(progress <= 75 && progress > 50) PROGRESS_BAR.style.backgroundColor = "yellow";
